...
async function seedDatabase() {
  ...
  for (const m of machines) {
    insertMachine.run(m.model_name, m.category, m.price, m.gst_percent, m.description, m.specifications, m.faqs);
  }
  ...
  for (const l of leads) {
    insertLead.run(l.name, l.phone, l.email, l.city, l.source, l.requirement, l.status, l.assigned_to, l.next_followup_date);
  }
